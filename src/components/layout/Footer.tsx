    ...
    <footer className="bg-slate-950 text-slate-300 pt-20 pb-8">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed text-slate-400 mb-6">
              {SITE_CONFIG.description.slice(0, 140)}...
            </p>
            {/* Social Icons */}
            <div className="flex gap-3">
              {Object.entries(SITE_CONFIG.social).map(([platform, url]) => (
                <a
                  ...
                  className="w-10 h-10 rounded-xl bg-slate-800 hover:bg-blue-600 flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5"
                >
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-500">{SITE_CONFIG.copyright}</p>
...
/** Simple SVG social icons to avoid icon-library dependency */
